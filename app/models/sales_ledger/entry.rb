...
module SalesLedger
  class Entry < ApplicationRecord
    ...
    PRODUCT_SOURCES  = %w[local importado].freeze
    ...
    validates :product_source, inclusion: { in: PRODUCT_SOURCES }, allow_nil: true
    ...
    scope :for_product_source,  ->(source) { where(product_source: source) }
  end
end
