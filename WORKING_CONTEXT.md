...
* **Mecanismo adoptado (ya cubierto por el comportamiento existente):**
  ...
  2. **El precio NO se edita después de la venta** fuera de una nueva venta — no hay edición de `order_items` ni edición de producto operativa (ver Products arriba). El precio "se fija" en el momento de vender.
